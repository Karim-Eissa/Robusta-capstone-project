    ...
    public function collection()
    {
        return $this->orders->map(function ($order) {
            return [
                ...
                'product_id' => $order->items->pluck('product_id')->implode(','),
                'product_name' => $order->items->pluck('product')->pluck('name')->implode(','),
                'quantity' => $order->items->pluck('quantity')->implode(','),
                'price' => $order->items->pluck('product')->pluck('price')->implode(','),
